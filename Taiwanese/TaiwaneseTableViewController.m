...
#import "TaiwaneseTableViewController.h"
#import "Entry.h"
#import "Definition.h"
#import "Example.h"
...
@interface TaiwaneseTableViewController ()
...
@implementation TaiwaneseTableViewController
...
//    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"SELF.defintions.english contains[c] %@",searchText];
//    self.filteredArray = [NSMutableArray arrayWithArray:[self.dictionaryArray filteredArrayUsingPredicate:predicate]];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([segue.identifier isEqualToString:@"Definition"]) {
        ...
        if (self.searchDisplayController.active) {
            ...
            entry = self.dictionaryArray[indexPath.row];
        }
